...
flowchart TD
  ...
  Μ --> |Όχι| K[Αλήθεια τώρα; Έχεις τολμήσει το Linux και δεν έχεις τολμήσει ήδη το Arduino IDE; Πρέπει κάποια στιγμή να ασχοληθείς και με αυτό, γιατί κινδυνεύεις να βρεθείς σε ατέρμονα βρόχο...] --> G
